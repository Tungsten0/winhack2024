      ...
      <div class="col-12 col-lg-6 col-xl-7">
        <div class="row justify-content-xl-center">
          <div class="col-12 col-xl-11">
            <h2 class="mb-3">Windsor's Marketplace</h2>
            <p class="lead fs-4 text-secondary mb-3">Welcome to Windsor's Marketplace, where we specialize in helping individuals and businesses build remarkable brands and exceptional products. Our mission is to provide unparalleled, captivating services that exceed expectations and leave a lasting impression.
</p>
